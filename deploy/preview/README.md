...
The page reads top to bottom as a short introduction followed by the live state of the box:

| section | what it is |
| --- | --- |
| title | the name, the host it runs on, the host spec and the theme switch |
...
The switch at the top right chooses **System**, **Light** or **Dark**. System is the default and
follows `prefers-color-scheme`, and a choice is kept in `localStorage` under
