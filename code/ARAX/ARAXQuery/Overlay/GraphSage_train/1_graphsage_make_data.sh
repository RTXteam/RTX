...
time python ./py_scripts/generate_random_walk.py --Gjson ./graphsage_input/data-G.json --walk_length 100 --number_of_walks 10 --batch_size 200000 --process 80 --output ./graphsage_input
