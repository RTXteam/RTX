...
def map_to_graph(row):
    ...
    if len(row) == 2:
        ...
        preferred_drug_curie = res['preferred_curie'] if (res is not None) and (res['preferred_category']=='biolink:Drug' or res['preferred_category']=='biolink:ChemicalSubstance' or res['preferred_category']=='biolink:Metabolite') else None
