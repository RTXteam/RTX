...
class LogReg():
    ...
    def __init__(self, node_vec_file = 'q_1_p_1_e_5_d_128_l_100_r_15_directed.emb', map_file = 'map.txt', TP_name_list = ['c_tp2.txt','NDF_TP2.txt'], TN_name_list = ['c_tn2.txt','NDF_TN2.txt'], cutoff = 2, output = './', pair_emb = 'concatenate', drugs_path='drugs.txt', diseases_path='diseases.txt'):
...
if __name__ == "__main__":
    lr = LogReg(node_vec_file = args.emb, map_file = args.map, TP_name_list = args.tp, TN_name_list = args.tn, cutoff = args.cutoff, output = args.output, pair_emb = args.pair_emb, drugs_path = args.drugs_path, diseases_path = args.diseases_path)
