...
class OverlayClinicalInfo:
    ...
    def __init__(self, response, message, params):
        ...
        self.who_knows_about_what = {'COHD': ['chemical_substance', 'phenotypic_feature', 'disease', 
                                                'biolink:ChemicalSubstance', 'biolink:PhenotypicFeature', 'biolink:Disease']}  # FIXME: replace this with information about the KP's, KS's, and their API's
