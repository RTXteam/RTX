...
def main():
    ...
    elif params.example_number == 6232:  # TODO chunyu testing #623, nodes not in the KG and QG. This should throw an error initially. In the future we might want to add these nodes.
        query = {"previous_message_processing_plan": {"processing_actions": [
            "create_message",
            "add_qnode(id=n00, curie=CHEMBL.COMPOUND:CHEMBL521)",
            "add_qnode(id=n01, type=protein)",
