...
class ARAXFilterKG:
    ...
    def __remove_edges_by_type(self, describe=False):
        ...
        if describe:
            brief_description = """`remove_edges_by_type` removes edges from the knowledge graph (KG) based on a given edge type.
            Use cases include:
    ...
    def __remove_edges_by_property(self, describe=False):
        ...
        # A little function to describe what this thing does
        if describe:
            brief_description = """`remove_edges_by_property` removes edges from the knowledge graph (KG) based on a given edge property.
                Use cases include:
    ...
    def __remove_edges_by_attribute(self, describe=False):
        ...
        # A little function to describe what this thing does
        if describe:
            brief_description = """`remove_edges_by_attribute` removes edges from the knowledge graph (KG) based on a a certain edge attribute.
    ...
    def __remove_nodes_by_type(self, describe=False):
        ...
        # A little function to describe what this thing does
        if describe:
            brief_description = """`remove_node_by_type` removes nodes from the knowledge graph (KG) based on a given node type.
            Use cases include:
