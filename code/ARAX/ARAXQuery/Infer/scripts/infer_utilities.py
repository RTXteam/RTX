...
class InferUtilities:
    ...
    def genrete_treat_subgraphs(self, response: ARAXResponse, top_scores: pd.DataFrame, top_paths: dict, drug_curie: Optional[str], disease_curie: Optional[str], qedge_id=None):
        ...
        # ── Post-processing: decorate and resultify ──
        # ARAXDecorator enriches nodes/edges with additional metadata from external sources.
        # resultify_and_sort groups edges into TRAPI Results and ranks by prediction score.
