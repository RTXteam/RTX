#!/bin/env python3
"""
InferUtilities: Builds TRAPI-compliant knowledge graph subgraphs from xDTD prediction results.
...
Note: Chemical-gene regulation (xCRG) has been moved to ARAX_connect.py (connect(action=xcrg)).
