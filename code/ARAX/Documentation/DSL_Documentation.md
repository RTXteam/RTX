...
|_DSL arguments_| {'an edge attribute name'} | {'std', 'top_std', 'top_n', 'n'} | {'above', 'below'} | {'a floating point number'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute name'} | {'above', 'below'} | {'a floating point number'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'a non-negative integer'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} |
...
|_DSL arguments_| {'d', 'ascending', 'a', 'descending'} | {'the maximum number of results to return'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} |
...
|_DSL arguments_| {'an node attribute'} | {'an node type'} | {'d', 'ascending', 'a', 'descending'} | {'the maximum number of results to return'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} |
...
|_DSL arguments_| {'an edge attribute'} | {'an edge relation'} | {'d', 'ascending', 'a', 'descending'} | {'the maximum number of results to return'} | {'T', 'True', 'false', 'true', 't', 'F', 'False', 'f'} |
