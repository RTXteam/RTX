...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'F', 'false', 'true', 'True', 'f', 'False', 't', 'T'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'F', 'false', 'true', 'True', 'f', 'False', 't', 'T'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute name'} | {'above', 'below'} | {'a floating point number'} | {'F', 'false', 'true', 'True', 'f', 'False', 't', 'T'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an node attribute'} | {'an node type'} | {'descending', 'ascending', 'a', 'd'} | {'the maximum number of results to return'} |
...
|_DSL arguments_| {'an edge attribute'} | {'an edge type'} | {'descending', 'ascending', 'a', 'd'} | {'the maximum number of results to return'} |
...
|_DSL arguments_| {'descending', 'ascending', 'a', 'd'} | {'the maximum number of results to return'} |
