...
|_DSL arguments_| {'an edge attribute name'} | {'below', 'above'} | {'a floating point number'} | {'false', 'False', 't', 'f', 'T', 'F', 'true', 'True'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'false', 'False', 't', 'f', 'T', 'F', 'true', 'True'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'false', 'False', 't', 'f', 'T', 'F', 'true', 'True'} | {'a specific query node id to remove'} |
