...
|_DSL arguments_| {'an edge attribute name'} | {'below', 'above'} | {'a floating point number'} | {'f', 'False', 'F', 'T', 't', 'true', 'false', 'True'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'f', 'False', 'F', 'T', 't', 'true', 'false', 'True'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'f', 'False', 'F', 'T', 't', 'true', 'false', 'True'} | {'a specific query node id to remove'} |
