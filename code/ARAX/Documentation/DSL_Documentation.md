...
- [Full documentation of current DSL commands](#full-documentation-of-current-dsl-commands)
  ...
  - [ARAX_filter_kg](#arax_filter_kg)
    - [`filter_kg(action=remove_edges_by_attribute_default)`](#filter_kgactionremove_edges_by_attribute_default)
...
## ARAX_filter_kg
### `filter_kg(action=remove_edges_by_attribute_default)`
...
||||||
|-----|-----|-----|-----|-----|
|_DSL parameters_| edge_attribute | type | remove_connected_nodes | qnode_id |
|_DSL arguments_| {'an edge attribute name'} | {'top_n', 'std', 'top_std', 'n'} | {'true', 'True', 'False', 'T', 'f', 't', 'F', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'true', 'True', 'False', 'T', 'f', 't', 'F', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute name'} | {'below', 'above'} | {'a floating point number'} | {'true', 'True', 'False', 'T', 'f', 't', 'F', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'true', 'True', 'False', 'T', 'f', 't', 'F', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute'} | {'an edge relation'} | {'a', 'descending', 'd', 'ascending'} | {'the maximum number of results to return'} |
...
|_DSL arguments_| {'a', 'descending', 'd', 'ascending'} | {'the maximum number of results to return'} |
...
|_DSL arguments_| {'an node attribute'} | {'an node type'} | {'a', 'descending', 'd', 'ascending'} | {'the maximum number of results to return'} |
