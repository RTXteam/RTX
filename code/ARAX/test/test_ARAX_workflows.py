...
def test_example_3():
    ...
    assert len(message.results) in range(60, 200)  # FIXME: BUG: sometimes the workflow returns 47 results, sometimes 48, sometime smore or less?! Probably due to API's not returning results (API calls to NGD and/or COHD sometimes don't go through)
    assert message.results[0].essence is not None
