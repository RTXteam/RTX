...
def test_issue1119_e():
    ...
    actions = [
        ...
        "add_qedge(key=e01, subject=n00, object=n02, option_group_id=1, predicate=biolink:predisposes)",
    ...
    actions = [
        ...
        "add_qedge(key=group1_e1, subject=n0, object=group1_n1, option_group_id=1, predicate=biolink:predisposes)",
...
def test_issue1119_f():
    ...
    actions = [
        ...
        "add_qnode(key=n01, id=CHEBI:48607)",
        "add_qnode(key=n02, category=biolink:Protein, option_group_id=1, is_set=true)",
        "add_qnode(key=n03, category=biolink:Pathway, option_group_id=1, is_set=true)",
        "add_qedge(key=e00, subject=n00, object=n01, predicate=biolink:related_to)",
        "add_qedge(key=e01, subject=n00, object=n02, option_group_id=1, predicate=biolink:predisposes)",
        "add_qedge(key=e02, subject=n02, object=n03, option_group_id=1, predicate=biolink:affects)",
        "add_qedge(key=e03, subject=n03, object=n01, option_group_id=1, predicate=biolink:disrupts)",
        "expand()",
        "resultify()",
        "return(message=true, store=false)"
    ]
