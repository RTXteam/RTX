        ...
        if match:
            ...
            if stored_response is not None:
                ...
                if enable_validation:
                    ...
                    envelope['validation_result'] = { 'status': 'DISABLED', 'version': schema_version, 'message': 'Validation disabled.', 'validation_messages': { "errors": [], "warnings": [], "information": [ 'Validation has been temporarily disabled due to problems with dependencies. Will return again soon.' ] } }
            ...
            if not is_parent_pk and 'fields' in response_dict and 'data' in response_dict['fields']:
                ...
                try:
                    if enable_validation:
                        ...
                        envelope['validation_result'] = { 'status': 'DISABLED', 'version': schema_version, 'size': content_size, 'message': 'Validation disabled. too many dependency failures', 'validation_messages': { "errors": [], "warnings": [], "information": [ 'Validation has been temporarily disabled due to problems with dependencies. Will return again soon.' ] } }
