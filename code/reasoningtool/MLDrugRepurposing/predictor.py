...
parser.add_argument("-e", "--emb", type=str, help="The filename or path to the emb file", default='data/graph.emb')
parser.add_argument("-m", "--model", type=str, help="The filename or path to the model .pkl file", default='data/LogReg.pkl')
parser.add_argument("--map", type=str, help="The filename or path of the map file generated by EdgelistMaker.py", default="data/map.csv")
parser.add_argument("-d", "--data", type=str, help="The filename or path of the csv of drug and disease curie ids you wish to predict on", default="data/data.csv")
parser.add_argument("-s", "--save", type=str, help="The filename or path of the csv you want to save your data to", default="data/prediction.csv")
...
class predictor():
    ...
    def import_file(self, file, graph_file = 'graph.emb', map_file = 'map.csv'):
        """
...
if __name__ == "__main__":
    ...
    pred.import_file(args.data,args.emb,args.map)
    df = pred.build_pred_df_all()
