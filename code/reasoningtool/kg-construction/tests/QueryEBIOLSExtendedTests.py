...
class QueryEBIOLSExtendedTestCase(TestCase):
    def test_get_anatomy_description(self):
        ...
        desc = QEBIEx.get_anatomy_description('UBERON:00044760')
        ...
        desc = QEBIEx.get_anatomy_description('CL:00000380')
        self.assertEqual(desc, 'None')
    ...
    def test_get_phenotype_description(self):
        ...
        desc = QEBIEx.get_phenotype_description('GO:00425350')
        self.assertEqual(desc, 'None')
    ...
    def test_get_bio_process_description(self):
        ...
        desc = QEBIEx.get_bio_process_description('HP:00111050')
        self.assertEqual(desc, 'None')
    ...
    def test_get_cellular_component_description(self):
        ...
        desc = QEBIEx.get_cellular_component_description('GO:00055730')
        self.assertEqual(desc, 'None')
    ...
    def test_get_molecular_function_description(self):
        ...
        desc = QEBIEx.get_molecular_function_description('GO:00046890')
        self.assertEqual(desc, 'None')

    def test_get_disease_description(self):
        desc = QEBIEx.get_disease_description('OMIM:613573')
        self.assertIsNotNone(desc)
        self.assertEqual(desc, get_from_test_file('OMIM:613573'))

        desc = QEBIEx.get_disease_description('OMIM:6135730')
        self.assertEqual(desc, 'None')