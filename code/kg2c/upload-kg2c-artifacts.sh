...
scp kg2c.sqlite${test_suffix} rtxconfig@${db_host}:${remote_database_dir}/kg2c_${kg2c_db_version}_KG${kg2_version}.sqlite${test_suffix}
scp meta_kg.json${test_suffix} rtxconfig@${db_host}:${remote_database_dir}/meta_kg_${kg2c_db_version}_KG${kg2_version}c.json${test_suffix}
scp fda_approved_drugs.pickle${test_suffix} rtxconfig@${db_host}:${remote_database_dir}/fda_approved_drugs_${kg2c_db_version}_KG${kg2_version}c.pickle${test_suffix}

# Then upload files not actually needed for running ARAX code
scp kg2c-tsv.tar.gz${test_suffix} rtxconfig@${db_host}:${remote_database_subdir}/kg2c-tsv.tar.gz${test_suffix}
