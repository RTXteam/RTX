// WARNING:
// This file was auto-generated by dsl2json.py on: 2021-02-05 21:22:52
//
var araxi_commands = {
  "create_envelope()": {
    "parameters": {},
  ...
  "expand(kp=GeneticsKP)": {
    "parameters": {
      ...
      "include_all_scores": {
        ...
        "default": "false",
        "type": "boolean",
        "description": "Whether to return all scores/edges returned from the GeneticsKP (including genetics-quantile edges) or only MAGMA p-value edges."
      }
    },
  ...
  "expand(kp=DTD)": {
    ...
    "description": "This command uses ARAX's in-house drug-treats-disease (DTD) database (built from GraphSage model) to expand a query graph; it returns edges between nodes with an DTD probability above a certain threshold. The default threshold is currently set to 0.8. If you set this threshold below 0.8, you should also set DTD_slow_mode=True otherwise a warninig will occur. This is because the current DTD database only stores the pre-calcualted DTD probability above 0.8. Therefore, if an user set threshold below 0.8, it will automatically switch to call DTD model to do a real-time calculation and this will be quite time-consuming."
  },
