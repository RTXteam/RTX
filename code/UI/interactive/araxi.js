// WARNING:
// This file was auto-generated by /mnt/data/orangeboard/devLM/RTX/code/UI/interactive/./dsl2json.py on: 2026-07-28 23:37:03
//
var araxi_commands = {
  "add_qedge()": {
    "parameters": {
  ...
  "connect(action=xcrg)": {
    "parameters": {},
    "description": "xcrg returns xCRG inferred ChemicalEntity-Gene results."
  },
  ...
  "infer(action=drug_treatment_graph_expansion)": {
    "parameters": {
      ...
      "n_drugs": {
        ...
        "default": 50,
        "type": "integer",
        "description": "Number of drug nodes to return for a disease query. Default 50, max 50."
      },
      "n_diseases": {
        "is_required": false,
        "examples": [
        ...
        "default": 50,
        "type": "integer",
        "description": "Number of disease nodes to return for a drug query. Default 50, max 50."
      },
      "n_paths": {
        "is_required": false,
        "examples": [
        ...
        "default": 25,
        "type": "integer",
        "description": "Number of explanation paths per result node. Default 25, max 25."
      }
    },
    "description": "Predicts drug/disease treatment relationships for a given disease/drug CURIE with predicted paths."
  }
}
