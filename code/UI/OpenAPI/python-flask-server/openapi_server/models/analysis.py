...
class Analysis(Model):
    ...
    def __init__(self, resource_id=None, score=None, edge_bindings=None, path_bindings=None, support_graphs=None, scoring_method=None, attributes=None):  # noqa: E501
        ...
        :param path_bindings: The path_bindings of this Analysis.  # noqa: E501
    ...
    def path_bindings(self):
        """Gets the path_bindings of this Analysis.

        The dictionary of input Query Graph to Knowledge Graph path bindings where the dictionary keys are the key identifiers of the Query Graph edges and the associated values of those keys are instances of EdgeBinding schema type (see below). This value is an array of EdgeBindings since a given query edge may resolve to multiple Knowledge Graph Edges.  # noqa: E501

        :return: The path_bindings of this Analysis.
    ...
    def path_bindings(self, path_bindings):
        """Sets the path_bindings of this Analysis.

        The dictionary of input Query Graph to Knowledge Graph path bindings where the dictionary keys are the key identifiers of the Query Graph edges and the associated values of those keys are instances of EdgeBinding schema type (see below). This value is an array of EdgeBindings since a given query edge may resolve to multiple Knowledge Graph Edges.  # noqa: E501

        :param path_bindings: The path_bindings of this Analysis.
        :type path_bindings: Dict[str, List[PathBinding]]
        """
