...
class Result(Model):
    ...
    def __init__(self, id=None, description=None, essence=None, essence_type=None, row_data=None, score=None, score_name=None, score_direction=None, confidence=None, result_type=None, result_group=None, result_group_similarity_score=None, reasoner_id=None, result_graph=None, knowledge_map=None):  # noqa: E501
        ...
        :type knowledge_map: Dict[str, object]
        """
        self.openapi_types = {
            'id': str,
            'description': str,
