...
class Response(Model):
    ...
    def __init__(self, message=None, status=None, description=None, logs=None, workflow=None, operations=None, reasoner_id=None, tool_version=None, schema_version=None, datetime=None, table_column_names=None, original_question=None, restated_question=None, query_options=None, context=None, type=None, id=None, validation_result=None):  # noqa: E501
        ...
        :type workflow: List[OneOfOperationOverlayOperationBindOperationOverlayComputeNgdOperationFillOperationFilterResultsOperationFilterKgraphOperationRestateOperationCompleteResultsOperationFilterResultsTopNOperationFilterKgraphOrphans]
    ...
    def workflow(self):
        ...
        :rtype: List[OneOfOperationOverlayOperationBindOperationOverlayComputeNgdOperationFillOperationFilterResultsOperationFilterKgraphOperationRestateOperationCompleteResultsOperationFilterResultsTopNOperationFilterKgraphOrphans]
        """
