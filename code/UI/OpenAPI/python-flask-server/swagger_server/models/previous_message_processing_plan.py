...
class PreviousMessageProcessingPlan(Model):
    ...
    def __init__(self, previous_message_uris: List[str]=None, previous_messages: List[Message]=None, processing_actions: List[str]=None, options: object=None):  # noqa: E501
        """PreviousMessageProcessingPlan - a model defined in Swagger
    ...
    @property
    def previous_message_uris(self) -> List[str]:
    ...
    def previous_message_uris(self, previous_message_uris: List[str]):
    ...
    def previous_messages(self, previous_messages: List[Message]):
    ...
    @property
    def processing_actions(self) -> List[str]:
    ...
    def processing_actions(self, processing_actions: List[str]):
