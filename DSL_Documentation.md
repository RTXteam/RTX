...
|_DSL arguments_| {'an edge property'} | {'a value for the edge property'} | {'True', 'F', 't', 'true', 'T', 'f', 'False', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge type'} | {'True', 'F', 't', 'true', 'T', 'f', 'False', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute name'} | {'below', 'above'} | {'a floating point number'} | {'True', 'F', 't', 'true', 'T', 'f', 'False', 'false'} | {'a specific query node id to remove'} |
...
|_DSL arguments_| {'an edge attribute'} | {'an edge type'} | {'ascending', 'a', 'descending', 'd'} | {'the maximum number of results to return'} |
