...
ssh ${remote_username}@${instance_hostname} bash -s '<(curl -s https://github.com/RTXteam/RTX/blob/master/DockerBuild/test-instance-scripts/build-test-arax-from-fresh-instance.sh)'
