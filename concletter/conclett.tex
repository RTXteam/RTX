...
that transforms the Stanford dependency graph (retrained on domanin-specific data from BioNLP contests \cite{bionlp:2013}) into a first-order logic formula (Figure~\ref{fig:parse}(b)).
