...
%(Fig.~\ref{fig:parse}(b)).
This representation of the user query will be used to set straight-forward constraints on the Markov chain used to generate a dossier of search strategies (Section \ref{section:MarkovChain}).
\begin{figure}[htbp]
\centering
\begin{tabular}{cc}
